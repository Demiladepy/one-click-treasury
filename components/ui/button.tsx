...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-secondary text-white shadow-lg hover:scale-[1.02] cta-gradient-sweep interactive-glow",
        primary:
          "bg-gradient-primary text-white shadow-lg hover:scale-[1.02] cta-gradient-sweep interactive-glow",
        outline:
          "border border-white/10 bg-white/5 hover:bg-white/10 interactive-glow",
        ghost: "hover:bg-white/5 interactive-glow",
